<div class="myfooter container-fluid">
  <footer class="py-3 ">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      <li class=" nav-item"><a href="{{route('home')}}" class="nav-link px-2 text-light">Home</a></li>
      ...
      <li class="nav-item"><a href="{{ route('form.revisor') }}" class="nav-link px-2 text-light">Lavora con noi</a></li>
