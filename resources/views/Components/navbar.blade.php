<nav class="navbar navbar1 navbar-expand-lg navbar navbar-dark ">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav navbar-custom1">
              ...
              @if(Auth::user()->is_revisor)
                <li>
                  <a class="dropdown-item1 text-light" href="{{ route('revisor.index') }}">{{ __('ui.revisorZone') }}
                    <span class="position-absolute pallino top-0 start-100 translate-middle badge rounded-pill bg-danger"> {{ App\Models\Product::toBeRevisionedCount() }}
